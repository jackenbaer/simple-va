// @title           OCSP Certificate Manager API
// @version         1.0.0
// @description     API for managing OCSP responder certificates and CSRs.
// @BasePath        /v1
package main
...
// @Router       /certificates/signed [post]
...
// @Router       /certificates/responder [post]
